\chapter{基于Hellinger-Reissner变分原理求解薄板问题}
...
\end{align}\par
此时，弯矩分量表达式中的$\tilde{\Psi}_{I,\alpha\beta}$是根据再生光滑梯度理论\cite{wang2019}构造的二阶再生光滑梯度。
...
\begin{figure}[H]
    ...
    \phantomcaption\label{PHRRQcputime}
    \includegraphics[width=0.49\textwidth]{figure/PHR/R/Qefficiency.png}
    \phantomcaption\label{PHRRQefficiency}
    \end{subcaptiongroup}
\caption{简支方板问题四次基函数效率对比：\subref{PHRRQcputime}计算时间与节点数的关系；\subref{PHRRQefficiency}本质边界条件施加效率分析}
\label{RQcputime}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \phantomcaption\label{PHRTCL2}
    \includegraphics[width=0.49\textwidth]{figure/PHR/T/CH1.png}
    \phantomcaption\label{PHRTCH1}
    \end{subcaptiongroup}
    \begin{subcaptiongroup}
    \includegraphics[width=0.49\textwidth]{figure/PHR/T/CH2.png}
    \phantomcaption\label{PHRTCH2}
    \includegraphics[width=0.49\textwidth]{figure/PHR/T/CH3.png}
    \phantomcaption\label{PHRTCH3}
    \end{subcaptiongroup}
\caption{简支等边三角形板问题三次基函数误差对比：\subref{PHRTCL2} $L_2$误差；\subref{PHRTCH1} $H_1$误差；\subref{PHRTCH2}$H_2$误差；\subref{PHRTCH3} $H_3$误差}
\label{TCLH}
\end{figure}
\newpage
\begin{figure}[!ht]
    ...
    \phantomcaption\label{PHRTQL2}
    \includegraphics[width=0.49\textwidth]{figure/PHR/T/QH1.png}
    \phantomcaption\label{PHRTQH1}
    \end{subcaptiongroup}
    \begin{subcaptiongroup}
    \includegraphics[width=0.49\textwidth]{figure/PHR/T/QH2.png}
    \phantomcaption\label{PHRTQH2}
    \includegraphics[width=0.49\textwidth]{figure/PHR/T/QH3.png}
    \phantomcaption\label{PHRTQH3}
    \end{subcaptiongroup}
\caption{简支等边三角形板问题四次基函数误差对比：\subref{PHRTQL2} $L_2$误差；\subref{PHRTQH1} $H_1$误差；\subref{PHRTQH2}$H_2$误差；\subref{PHRTQH3} $H_3$误差}
\label{TQLH}
\end{figure}
\begin{figure}[!ht]
    \centering
...
\begin{figure}[H]
    ...
    \phantomcaption\label{PHRAQL2}
    \includegraphics[width=0.49\textwidth]{figure/PHR/A/QH1.png}
    \phantomcaption\label{PHRAQH1}
    \end{subcaptiongroup}
    \begin{subcaptiongroup}
    \includegraphics[width=0.49\textwidth]{figure/PHR/A/QH2.png}
    \phantomcaption\label{PHRAQH2}
    \includegraphics[width=0.49\textwidth]{figure/PHR/A/QH3.png}
    \phantomcaption\label{PHRAQH3}
    \end{subcaptiongroup}
\caption{简支环行板问题四次基函数误差对比：\subref{PHRAQL2} $L_2$误差；\subref{PHRAQH1} $H_1$误差；\subref{PHRAQH2}$H_2$误差；\subref{PHRAQH3} $H_3$误差}
\label{AQLH}
\end{figure}
\newpage
\begin{figure}[H]
