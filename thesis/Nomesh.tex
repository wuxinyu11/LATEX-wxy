...
\begin{table}[H]
\centering
\caption{\textbf{二维内部节点无网格形函数及其导数图}}
\label{gradient1}
\begin{tabular}{cccc}
\toprule
$\quad$&$p=2$&$p=3$&$p=4$\\
...
$\Psi_{,xx}$&\begin{subcaptiongroup}\raisebox{-0.5\height}{\includegraphics[width=0.3\textwidth]{figure/nomesh/quadratic25/4.png}}\end{subcaptiongroup}
...
$\Psi_{,yy}$&\begin{subcaptiongroup}\raisebox{-0.5\height}{\includegraphics[width=0.3\textwidth]{figure/nomesh/quadratic25/5.png}}\end{subcaptiongroup}
...
$\Psi_{,xy}$&\begin{subcaptiongroup}\raisebox{-0.5\height}{\includegraphics[width=0.3\textwidth]{figure/nomesh/quadratic25/6.png}}\end{subcaptiongroup}
...
\begin{table}[H]
    \centering
    \caption{\textbf{二维边界点无网格形函数及其导数图}}
    \label{gradient2}
    \begin{tabular}{cccc}
    \toprule
    $\quad$&$p=2$&$p=3$&$p=4$\\
    ...
    $\Psi_{,xx}$&\begin{subcaptiongroup}\raisebox{-0.5\height}{\includegraphics[width=0.3\textwidth]{figure/nomesh/quadratic46/4.png}}\end{subcaptiongroup}
    ...
    $\Psi_{,yy}$&\begin{subcaptiongroup}\raisebox{-0.5\height}{\includegraphics[width=0.3\textwidth]{figure/nomesh/quadratic46/5.png}}\end{subcaptiongroup}
    ...
    $\Psi_{,xy}$&\begin{subcaptiongroup}\raisebox{-0.5\height}{\includegraphics[width=0.3\textwidth]{figure/nomesh/quadratic46/6.png}}\end{subcaptiongroup}
...
% \end{figure}
表(\ref{gradient1})、(\ref{gradient2})中分别存在内部节点和边界点处的无网格形函数及其导数图，从图中可知，无网格形函数具有全域高阶连续光滑的特点。但其无论是内部节点或边界点上的形函数在本点处均不具备插值性，即$\Psi_I(\pmb{x}_J)=\delta_{IJ}$。这将导致无网格法无法像有限元一样直接施加本质边界条件，需通过弱形式施加本质边界条件。
\section{伽辽金无网格法}
\subsection{弹性力学问题}
